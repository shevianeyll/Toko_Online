...
if ($_GET['id_transaksi']) {
    ...
    if ($acc) {
        echo "<script>alert('Success to send this order');location.href='penjualan.php';</script>";
    }
    else{
        echo "<script>alert('Failed to send this order');location.href='penjualan.php';</script>";
    }
}
?>