        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-md-8">
                <form action="profile_edit.php?" method="POST">
                    ...
                    <!-- nama petugas -->
                    <div class="mb-3">
                         <label class="form-label">Your Name : <?=$data_pelanggan['nama_pelanggan']?></label>
                    </div>
                    <!-- ttl -->
                    <div class="mb-3">
                        <label for="tanggal_lahir" class="form-label">Date of Birth : <?=$data_pelanggan['tanggal_lahir']?></label>
                    </div>
                    <!-- alamat -->
                    <div class="mb-3">
